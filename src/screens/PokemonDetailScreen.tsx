    ...
    <View style={pokemonDetailStyles.container}>
      {data ? (
        <View style={{flex: 1}}>
          ...
          <View
            style={[
              pokemonDetailStyles.header,
              {backgroundColor: theme.typeBackground[data.types[0].type.name]},
            ]}>
            <View style={pokemonDetailStyles.bannerContainer}>
              <Text
                numberOfLines={1}
                style={pokemonDetailStyles.bannerText}
                ellipsizeMode="clip">
                {data.name}
              </Text>
            </View>
            <Image
              ...
              style={pokemonDetailStyles.pokemonImage}
              resizeMode="contain"
            />
            <View style={{flex: 1}}>
                ...
                <View style={{flexDirection: 'row', flex: 1}}>
                  {data.types.map(type => {
                    return (
                      <View
                        style={[
                          pokemonDetailStyles.typeContainer,
                          {backgroundColor: theme.typeColors[type.type.name]},
                        ]}>
                        <Text style={pokemonDetailStyles.typetext}>
                          {type.type.name}
                        </Text>
                      </View>
                    );
          ...
          <View style={pokemonDetailStyles.detailContainer}>
            <Image
              source={{uri: data.types[0].type.url}}
              ...
              {data.abilities.map(ability => (
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        theme.typeColors[data.types[0].type.name],
                    },
                  ]}>
                  <Text
                    key={ability.ability.name}
                    style={pokemonDetailStyles.typetext}>
            ...
            <View>
              <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                <Image
                  source={{
                    uri: data.sprites.versions['generation-iv']['diamond-pearl']
                      .front_default,
                  }}
                  style={pokemonDetailStyles.pokemonSprite}
                  resizeMode="contain"
                />
                <Image
                  source={{
